        ...
        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
          <div class="hero__card card text-white bg-info mb-3 text-center">
            <div class="card-block">
              <p class="card-text-b"><svg class="icon icon-hero-card icon-phone"><use xlink:href="#icon-phone"></use></svg> Call Us</p>
              <hr />
              <p class="card-text-b"><a href="tel:+8885753483">Toll Free: 1.888.575.3483</a></p>
              <hr />
              <p class="card-text-b"><a href="/careers">Join the #PhytSquad</a></p>
            </div>
          </div>
        </div>
      </div>
