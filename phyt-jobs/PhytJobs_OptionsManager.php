...
class PhytJobs_OptionsManager {
    ...
    public function settingsPage() {
        if (!current_user_can('manage_options')) {
            wp_die(__('You do not have sufficient permissions to access this page.', 'phyt-jobs'));
        }
        ...
        ?>
        <div class="wrap">
            <h2><?php _e('System Settings', 'phyt-jobs'); ?></h2>
            <table cellspacing="1" cellpadding="2"><tbody>
            <tr><td><?php _e('System', 'phyt-jobs'); ?></td><td><?php echo php_uname(); ?></td></tr>
            <tr><td><?php _e('PHP Version', 'phyt-jobs'); ?></td>
                <td><?php echo phpversion(); ?>
                <?php
                if (version_compare('5.2', phpversion()) > 0) {
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    _e('(WARNING: This plugin may not work properly with versions earlier than PHP 5.2)', 'phyt-jobs');
                    echo '</span>';
                }
                ?>
                </td>
            </tr>
            <tr><td><?php _e('MySQL Version', 'phyt-jobs'); ?></td>
                <td><?php echo $this->getMySqlVersion() ?>
                    <?php
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    if (version_compare('5.0', $this->getMySqlVersion()) > 0) {
                        _e('(WARNING: This plugin may not work properly with versions earlier than MySQL 5.0)', 'phyt-jobs');
                    }
                    echo '</span>';
                    ?>
                </td>
            ...
            <h2><?php echo $this->getPluginDisplayName(); echo ' '; _e('Settings', 'phyt-jobs'); ?></h2>
            ...
            <?php settings_fields($settingsGroup); ?>
                ...
                <p class="submit">
                    <input type="submit" class="button-primary"
                           value="<?php _e('Save Changes', 'phyt-jobs') ?>"/>
                </p>
            </form>
        </div>
        <?php
    ...
    protected function getOptionValueI18nString($optionValue) {
        switch ($optionValue) {
            case 'true':
                return __('true', 'phyt-jobs');
            case 'false':
                return __('false', 'phyt-jobs');

            case 'Administrator':
                return __('Administrator', 'phyt-jobs');
            case 'Editor':
                return __('Editor', 'phyt-jobs');
            case 'Author':
                return __('Author', 'phyt-jobs');
            case 'Contributor':
                return __('Contributor', 'phyt-jobs');
            case 'Subscriber':
                return __('Subscriber', 'phyt-jobs');
            case 'Anyone':
                return __('Anyone', 'phyt-jobs');
        }
        return $optionValue;
    }
